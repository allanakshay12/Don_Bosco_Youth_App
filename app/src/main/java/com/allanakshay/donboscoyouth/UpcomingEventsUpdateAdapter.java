...
import static com.allanakshay.donboscoyouth.Admin_Update_Events.builder;

public class UpcomingEventsUpdateAdapter extends BaseAdapter implements ListAdapter {
    ...
    public UpcomingEventsUpdateAdapter(ArrayList<String> list, Context context, Activity activity, ArrayList<String> arraydate, ArrayList<String> arrayevent) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        editBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                refnum = fbdb.getInstance().getReference().child("Upcoming_Events");
                ...
                final boolean editandremove = !(arrayevent.get(position).endsWith("Birthday"));
                queryremove.addListenerForSingleValueEvent(editevent = new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for(DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            if (snapshot.child("Month").getValue().toString().equals(nlist) && snapshot.child("Date").getValue().toString().equals(narraydate) && editandremove) {
                                ...
                                Admin_Update_Events.maintainquery.removeEventListener(Admin_Update_Events.myevent);
                                intent = new Intent(context, Upcoming_Events_Update_Edit.class);
                        ...
                        if(editandremove == false)
                            Toast.makeText(context, "Editing/Removal of Birthdays is Prohibited", Toast.LENGTH_SHORT).show();
        ...
        removeBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(final View v) {
                if(!arrayevent.get(position).endsWith("Birthday")) {
                    ...
                    builder.setMessage("Are you sure you want to remove the Event:\n " + arrayevent.get(position) + "\n\nTaking place on:\n " + list.get(position) + " " + arraydate.get(position)).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                           ...
                           eventlist.clear();
                            ...
                            Snackbar.make(v, "Event Removed", Snackbar.LENGTH_SHORT).show();
