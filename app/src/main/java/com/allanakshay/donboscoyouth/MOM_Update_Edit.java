...
public class MOM_Update_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mom__update__edit);
        list = MOMUpdateAdapter.editstuff;
        ...
        final EditText event = (EditText)findViewById(R.id.admin_mom_mom_edit);

        final Spinner month = (Spinner)findViewById(R.id.admin_mom_month_edit);
        final Spinner date = (Spinner)findViewById(R.id.admin_mom_day_edit);
        ...
        Button update = (Button)findViewById(R.id.admin_mom_realupdate_edit);
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!(event.getText().toString().isEmpty())) {
                    ref = fbref.getInstance().getReference().child("MOM");
                    ...
                    Toast.makeText(getApplicationContext(), "Data Successfully Updated", Toast.LENGTH_SHORT).show();
                            ...
                            intent = new Intent(MOM_Update_Edit.this, Admin_Update_MOM.class);
                            startActivity(intent);
                            MOMUpdateAdapter.editstuff.clear();
                            finish();
