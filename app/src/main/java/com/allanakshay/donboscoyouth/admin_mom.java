...
public class admin_mom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_mom);
        update = (Button)findViewById(R.id.admin_mom_realupdate);
        month = (Spinner)findViewById(R.id.admin_mom_month);
        day = (Spinner)findViewById(R.id.admin_mom_day);
        MOM_edit = (EditText)findViewById(R.id.admin_mom_mom);
        ...
        ref = mFireBaseDatabase.getInstance().getReference().child("MOM");
            ...
            public void onClick(View v) {
                ...
                if(!MOM.isEmpty())
                {
                    ...
                    for (int i = 1; i <= Integer.parseInt(newnewpos); i++) {
                        newref.child(String.valueOf(i)).child("Notification_Viewed_MOM").setValue("No");
                    }
                    Intent intent = new Intent(admin_mom.this, Admin_Update_MOM.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(this, Admin_Update_MOM.class);
        startActivity(intent);
        finish();
    }
